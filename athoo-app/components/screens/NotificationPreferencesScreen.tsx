...
function createStyles(theme: AthooTheme) {
  return StyleSheet.create({
    ...
    title: { fontSize: 22, lineHeight: 27, fontWeight: "900", color: theme.colors.text },
    subtitle: { marginTop: 3, fontSize: 11.5, lineHeight: 17, color: theme.colors.textSecondary },
    ...
    statusTitle: { fontSize: 14, fontWeight: "900", color: theme.colors.text },
    statusText: { marginTop: 3, fontSize: 10.5, lineHeight: 15, color: theme.colors.textSecondary },
    refreshButton: { width: 34, height: 34, borderRadius: 11, alignItems: "center", justifyContent: "center", backgroundColor: theme.colors.surfaceAlt },
    systemButton: { minHeight: 50, borderRadius: 15, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingHorizontal: 14 },
    ...
    explainerText: { flex: 1, fontSize: 10.5, lineHeight: 16, color: theme.colors.textSecondary },
    sectionHeader: { marginTop: 2, gap: 2 },
    sectionTitle: { fontSize: 15, fontWeight: "900", color: theme.colors.text },
    sectionSubtitle: { fontSize: 10.5, lineHeight: 15, color: theme.colors.textMuted },
    categoryList: { gap: 9 },
    ...
    categoryIcon: { width: 40, height: 40, borderRadius: 13, alignItems: "center", justifyContent: "center", flexShrink: 0 },
    categoryCopy: { flex: 1, minWidth: 0 },
    categoryTop: { flexDirection: "row", alignItems: "center", gap: 8 },
    categoryTitle: { flex: 1, fontSize: 13.5, lineHeight: 18, fontWeight: "800", color: theme.colors.text },
    categoryStatus: { minHeight: 21, paddingHorizontal: 7, borderRadius: 10.5, justifyContent: "center" },
    categoryStatusText: { fontSize: 8.5, fontWeight: "900" },
    categoryDescription: { marginTop: 4, fontSize: 10.5, lineHeight: 15, color: theme.colors.textSecondary },
    policyRow: { marginTop: 8, flexDirection: "row", alignItems: "center", gap: 10, flexWrap: "wrap" },
    policyItem: { flexDirection: "row", alignItems: "center", gap: 4, maxWidth: "100%" },
    policyText: { flexShrink: 1, fontSize: 9, lineHeight: 13, fontWeight: "700", color: theme.colors.textMuted },
    safetyCard: {
      flexDirection: "row",
      alignItems: "flex-start",
      gap: 11,
    ...
    safetyIcon: { width: 40, height: 40, borderRadius: 13, alignItems: "center", justifyContent: "center", flexShrink: 0 },
    safetyCopy: { flex: 1, minWidth: 0 },
    safetyTitle: { fontSize: 13, fontWeight: "900", color: theme.colors.text },
    safetyText: { marginTop: 4, fontSize: 10.5, lineHeight: 16, color: theme.colors.textSecondary },
  });
}
