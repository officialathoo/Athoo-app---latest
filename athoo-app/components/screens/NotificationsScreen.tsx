...
const styles = StyleSheet.create({
  ...
  markAll: { minHeight: 42, borderRadius: 12, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginBottom: 2 },
  notification: { padding: 12},
  ...
  dismiss: { width: 34, height: 34, borderRadius: 10, alignItems: "center", justifyContent: "center", marginTop: -2, marginRight: -2 },
