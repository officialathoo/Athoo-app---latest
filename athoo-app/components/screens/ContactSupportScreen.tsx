...
const styles = StyleSheet.create({
  ...
  chip: { minHeight: 38, paddingHorizontal: 12, borderRadius: 19, borderWidth: 1.5, alignItems: "center", justifyContent: "center" },
  attach: { minHeight: 46, borderRadius: 13, borderWidth: 1.5, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9, paddingHorizontal: 16 },
  mediaRow: { minHeight: 44, borderRadius: 13, borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 9, paddingHorizontal: 12 },
  mediaName: { flex: 1 },
  remove: { width: 38, height: 38, alignItems: "center", justifyContent: "center" },
  messageInput: { minHeight: 120, borderRadius: 14, borderWidth: 1.5, paddingHorizontal: 13, paddingVertical: 12, fontSize: 15, lineHeight: 22 },
  errorBox: { borderRadius: 12, borderWidth: 1, padding: 13, flexDirection: "row", alignItems: "flex-start", gap: 10 },
  progressNote: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9 },
  successWrap: { flex: 1, alignItems: "center", justifyContent: "center", gap: 14, paddingHorizontal: 24 },
