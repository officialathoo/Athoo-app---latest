...
// City list is loaded live from /api/service-areas (the admin-managed,
// Pakistan-wide service_areas reference table) instead of a hardcoded array,
// so every screen that uses this picker always reflects the same canonical,
// admin-editable location data — no duplicate/stale city lists in the app.
...
export function CityPicker({
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch(() => {
        // silent fail — keep an empty list; the picker still shows the
        // current value and the search box, just with no suggestions.
      })
      .finally(() => {
