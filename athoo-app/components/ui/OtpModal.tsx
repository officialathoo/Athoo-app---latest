...
function createStyles(theme: AthooTheme, isUrdu: boolean) {
  return StyleSheet.create({
    ...
    sentTo: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.primary, textAlign: "center", writingDirection: isUrdu ? "rtl" : "ltr" },
    ...
    hintText: { flex: 1, ...theme.typography.body, color: theme.colors.text, textAlign: isUrdu ? "right" : "left", writingDirection: isUrdu ? "rtl" : "ltr" },
    hintCode: { fontFamily: theme.typography.label.fontFamily, color: theme.colors.secondary },
    otpRow: { flexDirection: "row", gap: 8, marginVertical: 7, direction: "ltr" },
    otpInput: { width: 56, height: 60, borderRadius: theme.radius.md, borderWidth: redesign.visual.focusedBorderWidth, borderColor: theme.colors.border, ...theme.typography.h2, color: theme.colors.text, backgroundColor: theme.colors.input, textAlign: "center" },
    otpInputFilled: { borderColor: theme.colors.primary, backgroundColor: theme.colors.infoSoft },
    expiryText: { marginTop: 10, ...theme.typography.caption, color: theme.colors.textSecondary, textAlign: "center" },
    expiryExpired: { color: theme.colors.danger, fontFamily: theme.typography.label.fontFamily },
    error: { ...theme.typography.caption, color: theme.colors.danger, textAlign: "center", writingDirection: isUrdu ? "rtl" : "ltr" },
    ...
    verifyText: { ...theme.typography.label, color: theme.colors.white, writingDirection: isUrdu ? "rtl" : "ltr" },
    ...
    resendText: { ...theme.typography.label, color: theme.colors.primary, writingDirection: isUrdu ? "rtl" : "ltr" },
    ...
    cancelText: { ...theme.typography.body, color: theme.colors.textSecondary, writingDirection: isUrdu ? "rtl" : "ltr" },
