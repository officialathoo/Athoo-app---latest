...
const createStyles = (theme: AthooTheme) => StyleSheet.create({
  ...
  notFoundText: { ...theme.typography.h3, color: theme.colors.text },
  backLink: { ...theme.typography.label, color: theme.colors.primary },
  scroll: { flex: 1 },
  headerGrad: { paddingTop: 16, paddingBottom: 36, alignItems: "center", gap: 8, paddingHorizontal: redesign.layout.horizontalPadding },
  backBtn: {
    position: "absolute", top: 16, left: redesign.layout.horizontalPadding,
    width: redesign.control.iconButtonSize, height: redesign.control.iconButtonSize, borderRadius: theme.radius.md,
    backgroundColor: "rgba(255,255,255,0.18)", alignItems: "center", justifyContent: "center",
    borderWidth: redesign.visual.cardBorderWidth, borderColor: "rgba(255,255,255,0.22)",
  },
  heartBtn: {
    position: "absolute", top: 16, right: redesign.layout.horizontalPadding,
    flexDirection: "column", alignItems: "center", justifyContent: "center",
    paddingHorizontal: 10, minHeight: redesign.control.iconButtonSize, borderRadius: theme.radius.md,
    backgroundColor: "rgba(255,255,255,0.18)", gap: 2,
    borderWidth: redesign.visual.cardBorderWidth, borderColor: "rgba(255,255,255,0.22)",
  },
  heartBtnLabel: {
    ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: "rgba(255,255,255,0.85)",
  },
  ...
  providerName: { ...theme.typography.h2, color: theme.colors.onBrand, marginTop: 4, letterSpacing: -0.25 },
  badgesRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, justifyContent: "center" },
  serviceTag: {
    flexDirection: "row", alignItems: "center", gap: 5,
    paddingHorizontal: 10, minHeight: 30, justifyContent: "center", borderRadius: theme.radius.pill,
    backgroundColor: "rgba(255,255,255,0.2)",
  },
  serviceTagText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.onBrand },
  ...
  statsCard: {
    ...
    marginTop: -20, marginHorizontal: redesign.layout.horizontalPadding, borderRadius: theme.radius.lg, padding: 16,
    borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.border,
    ...theme.shadows.md,
  },
  statItem: { flex: 1, alignItems: "center", gap: 3 },
  statVal: { ...theme.typography.h3, color: theme.colors.text },
  ...
  serviceSelectorCard: { marginHorizontal: redesign.layout.horizontalPadding, marginTop: 14, padding: 14, borderRadius: theme.radius.lg, backgroundColor: theme.colors.surface, borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.border, gap: 12, ...theme.shadows.sm },
  serviceSelectorHeader: { flexDirection: "row", alignItems: "center", gap: 10 },
  serviceSelectorIcon: { width: 34, height: 34, borderRadius: theme.radius.md, alignItems: "center", justifyContent: "center", backgroundColor: theme.colors.infoSoft },
  serviceSelectorTitle: { ...theme.typography.label, color: theme.colors.text },
  serviceSelectorText: { marginTop: 2, ...theme.typography.caption, color: theme.colors.textSecondary },
  serviceSelectorChips: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  serviceSelectorChip: { flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10, minHeight: 34, borderRadius: theme.radius.pill, borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.border, backgroundColor: theme.colors.surfaceAlt },
  serviceSelectorChipSelected: { borderWidth: redesign.visual.focusedBorderWidth },
  serviceSelectorChipText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.textSecondary },
  tabs: {
    flexDirection: "row", marginHorizontal: redesign.layout.horizontalPadding, marginTop: 20,
    backgroundColor: theme.colors.surfaceAlt, borderRadius: theme.radius.md, padding: 4,
  },
  tab: { flex: 1, minHeight: redesign.control.compactHeight, alignItems: "center", justifyContent: "center", borderRadius: theme.radius.md },
  tabActive: { backgroundColor: theme.colors.surface, ...theme.shadows.sm },
  tabText: { ...theme.typography.label, color: theme.colors.textSecondary },
  tabTextActive: { color: theme.colors.text },
  section: { padding: redesign.layout.horizontalPadding, gap: 16 },
  bio: { ...theme.typography.body, color: theme.colors.text },
  infoCard: { backgroundColor: theme.colors.surface, borderRadius: theme.radius.lg, overflow: "hidden", borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.border, ...theme.shadows.sm },
  infoRow: { flexDirection: "row", alignItems: "center", gap: 12, padding: 14 },
  infoIconBg: { width: 34, height: 34, borderRadius: theme.radius.md, backgroundColor: theme.colors.infoSoft, alignItems: "center", justifyContent: "center" },
  infoLabel: { ...theme.typography.caption, color: theme.colors.textSecondary, width: 80 },
  infoVal: { flex: 1, ...theme.typography.label, color: theme.colors.text },
  privacyCard: {
    flexDirection: "row", alignItems: "flex-start", gap: 12,
    backgroundColor: theme.colors.successSoft, borderRadius: theme.radius.md, padding: 14,
    borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.success + "25",
  },
  privacyTitle: { ...theme.typography.label, color: theme.colors.text },
  privacyText: { ...theme.typography.caption, color: theme.colors.textSecondary, marginTop: 2 },
  skillsTitle: { ...theme.typography.label, color: theme.colors.text, marginBottom: 8 },
  ...
  skillText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.text },
  skillChipSelected: { borderWidth: 2 },
  emptyReviews: { alignItems: "center", paddingVertical: 60, gap: 10 },
  emptyReviewsTitle: { ...theme.typography.h3, color: theme.colors.text },
  emptyReviewsText: { ...theme.typography.body, color: theme.colors.textSecondary, textAlign: "center" },
  reviewCard: {
    backgroundColor: theme.colors.surface, borderRadius: theme.radius.lg, padding: 14,
    borderWidth: redesign.visual.cardBorderWidth, borderColor: theme.colors.border, gap: 10, ...theme.shadows.sm,
  },
  ...
  reviewName: { ...theme.typography.label, color: theme.colors.text },
  ...
  reviewService: { ...theme.typography.caption, color: theme.colors.textMuted },
  footer: {
    backgroundColor: theme.colors.surface, paddingHorizontal: redesign.layout.horizontalPadding, paddingTop: 14,
  ...
  footerPriceLabel: { ...theme.typography.caption, color: theme.colors.textSecondary },
  footerPrice: { ...theme.typography.h3, color: theme.colors.primary },
  footerService: { marginTop: 1, ...theme.typography.caption, color: theme.colors.textMuted, fontFamily: theme.typography.label.fontFamily },
  availBadge: {
    flexDirection: "row", alignItems: "center", gap: 5,
    backgroundColor: theme.colors.successSoft, paddingHorizontal: 12, minHeight: 30, justifyContent: "center", borderRadius: theme.radius.pill,
  },
  ...
  availText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.success },
  busyText: { color: theme.colors.danger },
  footerBtns: { flexDirection: "row", gap: 10, alignItems: "center" },
  chatBtn: {
    width: redesign.control.standardHeight, height: redesign.control.standardHeight, borderRadius: theme.radius.md,
    backgroundColor: theme.colors.infoSoft, alignItems: "center", justifyContent: "center",
    borderWidth: redesign.visual.inputBorderWidth, borderColor: theme.colors.primary + "30",
  },
  negotiateBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6,
    paddingHorizontal: 14, minHeight: redesign.control.standardHeight, borderRadius: theme.radius.md,
    backgroundColor: theme.colors.secondary + "15", borderWidth: redesign.visual.inputBorderWidth, borderColor: theme.colors.secondary + "30",
  },
  negotiateBtnText: { ...theme.typography.label, color: theme.colors.secondary },
  bookBtn: { flex: 1, borderRadius: theme.radius.md, overflow: "hidden", ...theme.shadows.sm },
  bookBtnGrad: { minHeight: redesign.control.standardHeight, alignItems: "center", justifyContent: "center", paddingHorizontal: 16 },
  bookBtnText: { ...theme.typography.label, color: theme.colors.onBrand },
});
