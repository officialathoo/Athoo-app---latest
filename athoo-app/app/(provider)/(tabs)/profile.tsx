...
const createStyles = (theme: AthooTheme) => StyleSheet.create({
  ...
  headerGrad: { paddingHorizontal: 16, paddingBottom: 18},
  ...
  avatarSection: { flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 14},
  ...
  menuSection: { marginTop: 12, paddingHorizontal: 14},
  ...
  logoutBtn: {
    ...
    gap: 8, paddingVertical: 12, backgroundColor: theme.colors.danger + "10",
    borderRadius: 12, marginHorizontal: 14, marginTop: 12,
  },
