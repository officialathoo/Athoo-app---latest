        ...
        {loadingChats ? (
          ...
          <View style={styles.empty}>
            ...
            <Text style={[styles.emptySubtitle, localizedText, { color: theme.colors.textSecondary }]}>
              {tr("Customer messages will appear here")}
            </Text>
          </View>
        ) : (
          myChats.map((chat, index) => {
            ...
            const otherName = isParticipantOne
              ? (chat.participant2Name || t.customer)
              : (chat.participant1Name || t.customer);
            ...
            return (
              ...
              >
                {otherProfile?.profileImage ? (
                  ...
                  <View
                    style={[
                      styles.avatar,
                      {
                        backgroundColor: otherProfile?.profileColor || theme.colors.secondary,
                ...
                <View style={styles.chatContent}>
                  ...
                  {chat.service ? (
                    <Text style={[styles.serviceTag, localizedText, { color: theme.colors.secondary }]} numberOfLines={1}>
                      {chat.service}
                    </Text>
                  ) : null}
                </View>
