...
const createStyles = (theme: AthooTheme) => StyleSheet.create({
  ...
  headerGrad: { paddingHorizontal: 16, paddingBottom: 18, paddingTop: 12},
  backBtn: {
    width: 36, height: 36, borderRadius: 12,
    backgroundColor: "rgba(255,255,255,0.2)", alignItems: "center", justifyContent: "center",
    marginBottom: 10,
  },
  headerTitle: { fontSize: 20, fontWeight: "800", color: theme.colors.onBrand, marginBottom: 12},
  headerStats: {
    flexDirection: "row",
  ...
  weekSummaryRow: { flexDirection: "row", gap: 14},
  weekSummaryItem: { gap: 2 },
  weekSummaryVal: { fontSize: 18, fontWeight: "800" },
