...
function createStyles(theme: AthooTheme, isUrdu: boolean) {
  return StyleSheet.create({
    ...
    headerRow: { flexDirection: isUrdu ? "row-reverse" : "row", alignItems: "center", justifyContent: "space-between", marginBottom: 12},
    ...
    heroCard: { backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.3)" },
    ...
    duesCard: { backgroundColor: theme.colors.warningSoft, borderRadius: 14, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: theme.colors.warning },
    ...
    actionsRow: { flexDirection: isUrdu ? "row-reverse" : "row", gap: 8, marginBottom: 12},
    actionBtn: { flex: 1, minHeight: 80, alignItems: "center", justifyContent: "flex-start", gap: 8, paddingVertical: 4 },
    actionGrad: { width: 46, height: 46, borderRadius: 14, justifyContent: "center", alignItems: "center" },
    ...
    statsGrid: { flexDirection: isUrdu ? "row-reverse" : "row", gap: 8, marginBottom: 12},
    statCard: { flex: 1, minHeight: 92, backgroundColor: theme.colors.surface, borderRadius: 12, padding: 10, alignItems: "center", justifyContent: "center", gap: 4, borderWidth: 1, borderColor: theme.colors.border, ...theme.shadows.sm },
    ...
    empty: { backgroundColor: theme.colors.surface, borderRadius: 14, padding: 24, alignItems: "center", gap: 12, borderWidth: 1, borderColor: theme.colors.border },
    emptyText: { fontSize: 14, color: theme.colors.textSecondary, textAlign: "center", writingDirection: isUrdu ? "rtl" : "ltr" },
    txList: { backgroundColor: theme.colors.surface, borderRadius: 14, overflow: "hidden", borderWidth: 1, borderColor: theme.colors.border },
    txRow: { flexDirection: isUrdu ? "row-reverse" : "row", alignItems: "center", gap: 10, padding: 12},
    txBorder: { borderBottomWidth: 1, borderBottomColor: theme.colors.divider },
    txIcon: { width: 32, height: 32, borderRadius: 17, backgroundColor: theme.colors.successSoft, justifyContent: "center", alignItems: "center" },
    txCopy: { flex: 1 },
