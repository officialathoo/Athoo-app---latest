...
const createStyles = (theme: AthooTheme) => StyleSheet.create({
  ...
  saveBtn: { backgroundColor: theme.colors.primary, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 8},
  saveBtnText: { color: theme.colors.onBrand, fontWeight: "800", fontSize: 13 }, disabled: { opacity: 0.55 },
  content: { padding: 16, gap: 16}, notice: { flexDirection: "row", gap: 9, padding: 11, borderRadius: 12, backgroundColor: theme.colors.primary + "10", borderWidth: 1, borderColor: theme.colors.primary + "25" }, noticeText: { flex: 1, fontSize: 12, lineHeight: 18, color: theme.colors.textSecondary },
  input: { backgroundColor: theme.colors.surface, borderRadius: 12, borderWidth: 1, borderColor: theme.colors.border, paddingHorizontal: 12, paddingVertical: 11, fontSize: 15, color: theme.colors.text }, textArea: { minHeight: 92},
  chips: { flexDirection: "row", flexWrap: "wrap", gap: 6}, approvedChip: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 11, paddingVertical: 6, borderRadius: 999, backgroundColor: theme.colors.successSoft, borderWidth: 1, borderColor: theme.colors.successSoft },
  requestChip: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 11, paddingVertical: 6, borderRadius: 999, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border }, chipText: { fontSize: 12, fontWeight: "700", color: theme.colors.text },
  pendingServicesCard: { marginTop: -8, padding: 10, borderRadius: 12, backgroundColor: theme.colors.warningSoft, borderWidth: 1, borderColor: theme.colors.warning + "35", gap: 9 },
  ...
  rateStatusCard: { padding: 12, borderRadius: 12, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border, gap: 10},
