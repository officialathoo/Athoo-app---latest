    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <View style={[styles.container, { paddingTop: topPad }]} testID="provider-edit-profile-screen">
        ...
        <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 60 }]}>
          ...
          <Field label="Primary Work Location" hint="Your service-radius settings still control matching."><TextInput style={styles.input} value={location} onChangeText={setLocation} maxLength={160} placeholder="e.g. Rawalpindi, Islamabad" placeholderTextColor={Colors.textMuted} /></Field>
