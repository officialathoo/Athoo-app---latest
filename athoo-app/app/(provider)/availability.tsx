...
function createStyles(theme: AthooTheme) {
  return StyleSheet.create({
    ...
    scroll: { flex: 1 },
    scrollContent: { width: "100%", maxWidth: 760, alignSelf: "center", padding: 14},
    summaryCard: { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, marginBottom: 12, borderRadius: 14, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border },
    summaryText: { flex: 1 },
    ...
    summaryBadge: { width: 44, height: 44, borderRadius: 22, alignItems: "center", justifyContent: "center", backgroundColor: theme.colors.primary + "18" },
    summaryBadgeText: { fontSize: 15, fontWeight: "900", color: theme.colors.primary },
    quickActions: { gap: 6, paddingBottom: 12 },
    quickButton: { minHeight: 38, minWidth: 112, paddingHorizontal: 12, borderRadius: 10, alignItems: "center", justifyContent: "center", borderWidth: 1 },
    ...
    scheduleCard: { marginBottom: 12, borderRadius: 14, overflow: "hidden", backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border },
    dayBlock: { padding: 12},
    dayBlockBorder: { borderBottomWidth: 1, borderBottomColor: theme.colors.border },
    dayHeader: { minHeight: 40, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
    dayIdentity: { flex: 1, flexDirection: "row", alignItems: "center", gap: 10 },
    dayShortBadge: { width: 34, height: 34, borderRadius: 11, alignItems: "center", justifyContent: "center", backgroundColor: theme.colors.primary + "12" },
    ...
    timeRow: { flexDirection: "row", alignItems: "flex-end", gap: 8, marginTop: 10},
    ...
    timePicker: { minHeight: 42, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 6, paddingHorizontal: 10, borderRadius: 11, backgroundColor: theme.colors.surfaceAlt, borderWidth: 1, borderColor: theme.colors.border },
    timePickerPressed: { opacity: 0.78 },
    timePickerText: { flexShrink: 1, fontSize: 13, fontWeight: "700", color: theme.colors.text },
    timeConnector: { width: 24, height: 42, alignItems: "center", justifyContent: "center" },
    modalOverlay: { flex: 1, justifyContent: "center", padding: 20, backgroundColor: "rgba(0,0,0,0.55)" },
    timeSheet: { width: "100%", maxWidth: 440, maxHeight: "78%", alignSelf: "center", overflow: "hidden", borderRadius: 18, backgroundColor: theme.colors.surface, borderWidth: 1, borderColor: theme.colors.border },
    timeSheetHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 14, borderBottomWidth: 1, borderBottomColor: theme.colors.border },
    ...
    closeButton: { width: 36, height: 36, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: theme.colors.surfaceAlt },
    timeList: { flexGrow: 0 },
    timeListContent: { padding: 10 },
    timeOption: { minHeight: 44, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 12, borderRadius: 11 },
    ...
    infoBanner: { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 12, marginBottom: 12, borderRadius: 12, backgroundColor: theme.colors.infoSoft, borderWidth: 1, borderColor: theme.colors.info + "30" },
    ...
    saveGradient: { minHeight: 50, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, paddingHorizontal: 18 },
