...
function createStyles(theme: AthooTheme) {
  return StyleSheet.create({
    ...
    header: {
      ...
      paddingBottom: redesign.layout.fieldGap,
    },
    ...
    summaryText: { flex: 1 },
    summaryTitle: { ...theme.typography.h3, color: theme.colors.text },
    summarySubtitle: {
      marginTop: 3,
      ...theme.typography.caption,
    ...
    summaryBadgeText: { ...theme.typography.label, color: theme.colors.primary },
    quickActions: { gap: 8, paddingBottom: redesign.layout.cardGap },
    quickButton: {
    ...
    quickButtonText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily },
    scheduleCard: {
      marginBottom: redesign.layout.cardGap,
      borderRadius: radius.lg,
      overflow: "hidden",
    ...
    dayBlock: { padding: redesign.layout.cardGap },
    dayBlockBorder: {
    ...
    dayShortText: { ...theme.typography.caption, fontFamily: theme.typography.label.fontFamily, color: theme.colors.primary },
    dayLabel: { ...theme.typography.label, color: theme.colors.text },
    dayLabelDisabled: { color: theme.colors.textSecondary },
    dayStatus: { marginTop: 1, ...theme.typography.caption, color: theme.colors.textMuted },
    ...
    timePickerText: { flexShrink: 1, ...theme.typography.label, color: theme.colors.text },
    ...
    saveButtonDisabled: { opacity: redesign.visual.disabledOpacity },
    saveGradient: {
      minHeight: redesign.control.standardHeight,
      flexDirection: "row",
      alignItems: "center",
