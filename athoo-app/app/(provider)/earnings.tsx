...
function createStyles(theme: AthooTheme, isUrdu: boolean) {
  return StyleSheet.create({
    ...
    header: { flexDirection: isUrdu ? "row-reverse" : "row", alignItems: "center", gap: 12, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 12, backgroundColor: theme.colors.surface, borderBottomWidth: 1, borderBottomColor: theme.colors.border },
    backBtn: { width: 38, height: 38, borderRadius: 12, backgroundColor: theme.colors.surfaceAlt, alignItems: "center", justifyContent: "center" },
    ...
    earningsCard: { borderRadius: 18, padding: 18, gap: 12},
    ...
    earningsAmount: { fontSize: 32, fontWeight: "800", color: theme.colors.white, textAlign: isUrdu ? "right" : "left" },
    earningsRow: { flexDirection: isUrdu ? "row-reverse" : "row", backgroundColor: "rgba(255,255,255,0.15)", borderRadius: 12, padding: 10, alignItems: "center" },
    ...
    bold: { fontWeight: "700" },
    periodRow: { flexDirection: isUrdu ? "row-reverse" : "row", gap: 6},
    periodBtn: { flex: 1, minHeight: 40, paddingHorizontal: 8, borderRadius: 999, backgroundColor: theme.colors.surfaceAlt, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: theme.colors.border },
    ...
    txCard: { flexDirection: isUrdu ? "row-reverse" : "row", alignItems: "flex-start", gap: 10, backgroundColor: theme.colors.surface, borderRadius: 14, padding: 12, borderWidth: 1, borderColor: theme.colors.border },
    txIcon: { width: 36, height: 36, borderRadius: 12, backgroundColor: theme.dark ? theme.colors.premiumSoft : theme.colors.premiumSoft, alignItems: "center", justifyContent: "center" },
    txInfo: { flex: 1, gap: 2 },
    ...
    empty: { alignItems: "center", paddingVertical: 42, gap: 10, backgroundColor: theme.colors.surface, borderRadius: 14, borderWidth: 1, borderColor: theme.colors.border },
