...
EXPO_PUBLIC_MAP_TILE_URL=https://<api-domain>/api/geo/tiles/{z}/{x}/{y}.png
EXPO_PUBLIC_MAP_TILE_SIZE=512
EXPO_PUBLIC_MAP_ATTRIBUTION=<active-provider-attribution>
...
Complete every case in `docs/qa/device-acceptance-checklist.json`. Passed cases require:
