...
Execute every case in `device-acceptance-checklist.json` on at least one current Android device and one current iPhone. Record build, OS, timestamp, result, evidence, and notes.
