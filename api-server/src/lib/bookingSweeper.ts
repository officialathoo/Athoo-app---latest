...
import { bookingsTable, usersTable, negotiationsTable } from "@workspace/db/schema";
  ...
  const expiringSoon = await db
    ...
    .where(
      and(
        ...
        // Only remind once: don't remind if reminder was sent in the last 2 days
        // We approximate this by checking if plan hasn't expired yet (gt now)
