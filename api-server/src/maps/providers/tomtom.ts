...
function toResult(result: TomTomSearchResult): GeoResult | null {
  ...
  return {
    ...
    area: address.municipalitySubdivision || address.countrySecondarySubdivision,
    province: address.countrySubdivision,
    countryCode: String(address.countryCode || process.env.MAP_COUNTRY_CODE || "PK").toUpperCase(),
